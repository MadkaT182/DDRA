...
t[#t+1] = Def.ActorFrame {
	...
	LoadActor("text_"..lang)..{
		OnCommand=cmd(diffusealpha,0;Center;zoomy,0;sleep,0.8;diffusealpha,1;linear,0.066;zoom,1;Center);
		OffCommand=cmd(linear,0.134;zoomy,0);
	};
	LoadActor("top")..{
	...
	LoadActor("top")..{
		OnCommand=cmd(diffusealpha,0;sleep,0.884;diffusealpha,1;playcommand,"Animate");
