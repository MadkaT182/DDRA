...
t[#t+1] = LoadFont("Common Normal")..{
	InitCommand=cmd(player,PLAYER_2;zoom,1;draworder,6;y,SCREEN_CENTER_Y-227;horizalign,right);
...
--Marvelous--
t[#t+1] = LoadFont("Common Normal")..{
	InitCommand=cmd(player,PLAYER_2;zoom,0.72;draworder,5;y,SCREEN_CENTER_Y-206;horizalign,right);
	OnCommand=function(self)
...
--Perfect--
t[#t+1] = LoadFont("Common Normal")..{
	InitCommand=cmd(player,PLAYER_2;zoom,0.72;draworder,5;y,SCREEN_CENTER_Y-186;horizalign,right);
	OnCommand=function(self)
...
--Great--
t[#t+1] = LoadFont("Common Normal")..{
	InitCommand=cmd(player,PLAYER_2;zoom,0.72;draworder,5;y,SCREEN_CENTER_Y-166;horizalign,right);
	OnCommand=function(self)
		self:settextf(Great);
		self:diffuse(color("#000000"));
	end;
...
--Good--
t[#t+1] = LoadFont("Common Normal")..{
	InitCommand=cmd(player,PLAYER_2;zoom,0.72;draworder,5;y,SCREEN_CENTER_Y-146;horizalign,right);
	OnCommand=function(self)
		self:settextf(Good);
		self:diffuse(color("#000000"));
	end;
...
--Ok--
t[#t+1] = LoadFont("Common Normal")..{
	InitCommand=cmd(player,PLAYER_2;zoom,0.72;draworder,5;y,SCREEN_CENTER_Y-126;horizalign,right);
	OnCommand=function(self)
		self:settextf(Ok);
		self:diffuse(color("#000000"));
	end;
...
--Miss--(Almost+Miss)
t[#t+1] = LoadFont("Common Normal")..{
	InitCommand=cmd(player,PLAYER_2;zoom,0.72;draworder,5;y,SCREEN_CENTER_Y-106;horizalign,right);
	OnCommand=function(self)
		self:settextf(Miss);
		self:diffuse(color("#000000"));
	end;
...
--EX Score--
t[#t+1] = LoadFont("Common Normal")..{
	InitCommand=cmd(player,PLAYER_2;zoom,1;draworder,6;y,SCREEN_CENTER_Y-82;horizalign,right);
	OnCommand=function(self)
